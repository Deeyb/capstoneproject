...
(function initIdleTimeout(){
  ...
  function showWarning(){
    ...
    warningModal.innerHTML = `
      <div style="background: white; padding: 30px; border-radius: 10px; max-width: 400px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        ...
        <div style="display: flex; gap: 10px; justify-content: center;">
          <button id="stayLoggedInStudent" style="padding: 10px 20px; background: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer;">Stay Logged In</button>
          <button id="logoutNowStudent" style="padding: 10px 20px; background: #6c757d; color: white; border: none; border-radius: 5px; cursor: pointer;">Logout Now</button>
        </div>
      </div>
    `;
    ...
    document.getElementById('stayLoggedInStudent').onclick = function(){
      resetTimer();
    ...
    document.getElementById('logoutNowStudent').onclick = function(){
